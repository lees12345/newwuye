<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/list_message.html";i:1635479594;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635995797;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="table-responsive">
                    <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid"><div class="row"><div class="col-sm-6"><div id="sample-table-2_length" class="dataTables_length"></div></div><div class="col-sm-6">
                        ...
                        </th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 180px;">ID</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 125px;">内容</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">发送时间</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="
                        ...
                        <tr class="odd">
                            ...
                            <td class=""><?php echo $data['id']; ?>
                            </td>
                            <td class=" "><?php echo $data['content']; ?></td>
                            <td class=" "><?php echo $data['send_time']; ?></td>
				<td>
			<?php if(is_array($data['type']) || $data['type'] instanceof \think\Collection || $data['type'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?>
			    <?php echo $type['type_name']; endforeach; endif; else: echo "" ;endif; ?>
			</td>
                            <td class=" ">
                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                    ...
                                    </a><a class="red" href="<?php echo url('updateMessage'); ?>?id=<?php echo $data['id']; ?>">
                                    <i class="icon-trash bigger-130">修改内容</i>
                                </a>
