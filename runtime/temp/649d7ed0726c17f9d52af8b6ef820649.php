<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/resource/add.html";i:1635479598;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo url('insert'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2">资源excel表 </label>

                            <div class="col-sm-9">
                                <input type="file" name='class_picture'/>
                            </div>
                        </div>
