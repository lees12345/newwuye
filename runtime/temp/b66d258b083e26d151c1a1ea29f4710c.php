<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/report/upd.html";i:1635479598;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635484441;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/report/upd_pro'); ?>" method="post">
                                         
								<input type="hidden" name="history_id" value="<?php echo $data['history_id']; ?>" />
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">报告标题 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='history_title' value='<?php echo $data['history_title']; ?>'/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 报告标签</label>

										<div class="col-sm-9">
											<input type="radio" name="history_type" value='1'>周报
                                            <input type="radio" name="history_type" value='2'>月报
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 报告摘要</label>
										<div class="col-sm-9">
                                            <textarea name='history_desc'><?php echo $data['history_desc']; ?></textarea>
									</div>
									</div>
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">报告内容 </label>
										<div class="col-sm-9">
										<textarea placeholder="请输入内容" id="container" name="history_content"  type="text/plain" style="width:600px;height:200px;"><?php echo $data['history_content']; ?></textarea>
										</div>
									</div>
