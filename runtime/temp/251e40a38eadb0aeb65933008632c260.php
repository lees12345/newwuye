<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/sell.html";i:1635479596;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/news/sell_update'); ?>" method="post">
                    <?php echo token('__hash__'); ?>
                    <input type="hidden" name="news_id" value="<?php echo $data['id']; ?>">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">卖出状态 </label>

                        <div class="col-sm-9" style="line-height:32px">
                            <input type="radio" name="shares_status" value='1' <?php if($data['shares_status'] == 1): ?> checked <?php endif; ?>>成功
                            <input type="radio" name="shares_status" value='2' <?php if($data['shares_status'] == 2): ?> checked <?php endif; ?>>失败
                            <input type="radio" name="shares_status" value='3' <?php if($data['shares_status'] == 3): ?> checked <?php endif; ?>>调仓
                            <!--<input type="radio" name="shares_status" value='3' <?php if($data['shares_status'] == 3): ?> checked <?php endif; ?>>调仓-->
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 卖出时间 </label>
                        <div class="col-sm-9">
                            <input type="text" name="end_time" value="<?php echo $data['end_time']; ?>">格式：2020-10-10 10:10:10
                        </div>
                    </div>
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <input type="submit" value='修改状态' class="btn btn-info">
                        </div>
                    </div>
