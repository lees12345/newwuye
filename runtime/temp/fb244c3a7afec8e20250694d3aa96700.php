<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/apply/index.html";i:1635479594;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635995797;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
...
<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 搜索框 -->
			<form class="form-search" action="<?php echo url('wxadmint1/apply/index'); ?>">
			...
			<br/>
						<span class="btn btn-sm" data-rel="tooltip" title="" data-original-title="Default">总审核申请条数：<?php echo $us; ?></span>
						...
						<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($key % 2 );++$key;?>
								...
								<tbody>
									<tr>
										...
										<td>
											<?php echo $data['user_tel']; ?>
										</td>
										<td><?php echo $data['apply_num']; ?></td>
										<td><?php echo date('Y-m-d H:i:s',$data['apply_addtime']); ?></td>
										<td><?php if($data['apply_status'] == 2): ?>同意<?php else: ?>未同意<?php endif; ?></td>
										<td>
