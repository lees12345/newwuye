<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/admin_index.html";i:1635479593;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		...
		<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search" method="post" action="<?php echo url('wxadmint1/admin/auth_insert'); ?>">
						...
						<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid"><div class="row"><div class="col-sm-6"><div id="sample-table-2_length" class="dataTables_length"></div></div><div class="col-sm-6">
											<form action="" method="get">
											<input name="v" type="hidden" value="zqwd">
											<div class="dataTables_filter" id="sample-table-2_filter">
											<span class="input-icon">
												<select required name="id">
													<option value="">请选择分组类型</option>
													<?php if(is_array($tt) || $tt instanceof \think\Collection || $tt instanceof \think\Paginator): $i = 0; $__LIST__ = $tt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tt): $mod = ($i % 2 );++$i;?>
														<option value="<?php echo $tt['id']; ?>"><?php echo $tt['title']; ?></option>
													<?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</span>
											<label>搜索: <input name="admin_name" type="text" aria-controls="sample-table-2" placeholder="名称"></label><input class="btn btn-purple btn-sm" type="submit" value="搜索">

											</div>
											</form>
											</div></div><table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
												<thead>
													<tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="
														...
														</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 180px;">ID</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 125px;">名称</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">所属分组</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">最近登录时间</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">登录次数</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">创建时间</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="
											...
											<tr class="odd">
														...
														<td class="">
															<a href="#"><?php echo $list['admin_id']; ?></a>
														</td>
														<td class=" "> <?php echo $list['admin_name']; ?> </td>
														<td class=" "> <?php echo $list['title']; ?> </td>
														<td class=" "><?php echo date('Y-m-d H:i:s',$list['admin_time']); ?></td>
														<td class=" "><?php echo $list['admin_num']; ?></td>
														<td class=" "><?php echo date('Y-m-d H:i:s',$list['admin_ctime']); ?></td>
														...
														<td class=" ">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo url('wxadmint1/admin/admin_edit'); ?>?admin_id=<?php echo $list['admin_id']; ?>">
																	<i class="icon-pencil bigger-130">修改</i>
																</a>
																<a class="red" href="<?php echo url('wxadmint1/admin/admin_del'); ?>?admin_id=<?php echo $list['admin_id']; ?>">
													...
													</table><div class="row"><div class="col-sm-6"><div class="dataTables_info" id="sample-table-2_info"></div></div><div class="col-sm-6"><div class="dataTables_paginate paging_bootstrap">
													<!-- <ul class="pagination"><li class="prev disabled"><a href="#"><i class="icon-double-angle-left"></i></a></li><li class="active"><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li class="next"><a href="#"><i class="icon-double-angle-right"></i></a></li></ul> -->
