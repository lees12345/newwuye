<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/profit/index.html";i:1635479597;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                    ...
                    <div class="col-xs-12">
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <td><?php echo $list['profit_id']; ?></td>
                                    <td><?php echo $list['profit_date']; ?></td>
                                    <td><?php echo $list['sse_profit']; ?></td>
                                    <td><?php echo $list['sse_profit_rate']; ?>%</td>
                                </tr>
                                </tbody>
