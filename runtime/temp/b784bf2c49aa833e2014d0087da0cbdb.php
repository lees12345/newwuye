<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/index.html";i:1637749147;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
										...
										<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
												<tbody>
													<tr>
														...
														<td><?php if($data['is_shares'] == 1): ?><a href="<?php echo url('news/recods'); ?>?news_id=<?php echo $data['id']; ?>"><?php echo $data['mt_name']; ?></a> <?php else: ?><?php echo $data['mt_name']; endif; ?></td>
														...
														<td><?php if($data['is_shares'] == 1): if($data['shares_status'] == 0): ?><span style="color:yellowgreen;">持股</span>
															<?php elseif($data['shares_status'] == 1): ?> <span style="color:red;">止盈</span>
															<?php elseif($data['shares_status'] == 2): ?> <span style="color:green;">止损</span>
															<?php elseif($data['shares_status'] == 3): ?> <span style="color:blue;">调仓</span> <?php endif; endif; ?></td>
														...
														<td><?php if(is_array($data['users_type']) || $data['users_type'] instanceof \think\Collection || $data['users_type'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['users_type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?> <?php echo $type; ?>|<?php endforeach; endif; else: echo "" ;endif; ?></td>
														<td>
														...
														<!--<td>-->
															<!--<a onclick="if(!confirm('您确定同步信息吗？')){return false;}"  href="<?php echo url('wxadmint1/news/synchro'); ?>?id=<?php echo $data['id']; ?>">-->
