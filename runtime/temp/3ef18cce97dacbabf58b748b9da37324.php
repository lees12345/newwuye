<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/upd.html";i:1635479596;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/news/xiu'); ?>" method="post">
								...
								<input type="hidden" name="news_id" value="<?php echo $data['id']; ?>">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="news_code" value="<?php echo $data['news_code']; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<textarea id="container" name="new_content" type="text/plain" style="width:600px;height:200px;"><?php echo $data['new_content']; ?></textarea>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 研报url </label>
										<div class="col-sm-9">
											<input type="text" name="shares_report_url" value="<?php echo $data['information']['shares_report_url']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 收益 </label>
										<div class="col-sm-9">
											<input type="text" name="profit" value="<?php echo $data['profit']; ?>">%
										</div>
									</div>
