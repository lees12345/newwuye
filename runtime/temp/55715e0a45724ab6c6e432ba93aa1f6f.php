<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/order/add.html";i:1635921341;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635921773;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/order/insert'); ?>" method="post">
                    <input type="hidden" name="name" value="formal"/>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">订单号</label>
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" placeholder="订单号(没有则不填)" class="col-xs-10 col-sm-5" name='order_no' />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">用户手机号</label>
                        <div class="col-sm-9">
                            <input type="text" id="form-field-1" placeholder="请输入客户电话" class="col-xs-10 col-sm-5" name='user_tel' />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">订单开始日期(年月日)</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input class="form-control date-picker" id="id-date-picker-1" type="text" name='start_time' data-date-format="dd-mm-yyyy" />
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">订单结束日期(年月日)</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input class="form-control date-picker" id="id-date-picker-1" type="text" name='end_time' data-date-format="dd-mm-yyyy" />
                                <span class="input-group-addon">
                                                            <i class="icon-calendar bigger-110"></i>
                                                        </span>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">产品类型</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                ...
                                <input type="radio" name="product_id" value="<?php echo $product['id']; ?>" checked/><?php echo $product['product_name']; ?><?php echo $product['body']; endforeach; endif; else: echo "" ;endif; ?>
                            </div>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">购买类型</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="radio" name="type" value="1" checked>按次
                                <input type="radio" name="type" value="2"/>包月
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">购买数量</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input type="number" id="form-field-1" class="col-xs-10 col-sm-5" name='number' value="0" />次
                            </div>
                        </div>
                    </div>
