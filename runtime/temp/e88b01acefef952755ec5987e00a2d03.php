<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/refund/index.html";i:1635479597;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635995797;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- 搜索框 -->
							<form class="form-search" action="<?php echo url('wxadmint1/refund/index'); ?>">
							  <input type="hidden" name="v" value="1">
								<span class="input-icon">
									<input type="text" placeholder="请输入用户手机号或姓名" class="nav-search-input" id="nav-search-input" autocomplete="off" name='search'/>
									<i class="icon-search nav-search-icon"></i>
								</span>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td><?php echo $data['users']['user_name']; ?></td>
														<td><?php echo $data['users']['user_tel']; ?></td>
														<td><?php if($data['users']['type_id'] == 1): ?>游客<?php elseif($data['users']['type_id'] == 2): ?>注册用户<?php elseif($data['users']['type_id'] == 3): ?>    <font color="#FF0000">签约用户</font> <?php elseif($data['users']['type_id'] == 4): ?>结束用户<?php elseif($data['users']['type_id'] == 6): ?>内部员工<?php elseif($data['users']['type_id'] == 7): ?>升级用户<?php elseif($data['users']['type_id'] == 8): ?>暂停服务<?php elseif($data['users']['type_id'] == 19): ?>体验用户<?php elseif($data['users']['type_id'] == 20): ?>体验结束<?php elseif($data['users']['type_id'] == 21): ?>测试分组<?php endif; ?></td>
														<td><textarea><?php echo $data['question_content']; ?></textarea></td>

														
														<td><?php echo date('Y-m-d H:i:s',$data['question_addtime']); ?></td>
														<td><?php echo $data['question_type']; ?></td>
													<!--	<td>未回复</td>-->
														<!--<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

															&lt;!&ndash;	<a onclick="if(!confirm('是否回复该问题？')){return false;}"  href="<?php echo url('wxadmint1/refund/reply'); ?>?question_id=<?php echo $data['question_id']; ?>"><button class="btn btn-xs">
