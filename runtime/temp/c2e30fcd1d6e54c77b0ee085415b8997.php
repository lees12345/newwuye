<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/tishi.html";i:1635660715;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/news/tishi_insert'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="news_code" value="<?php echo $news_code; ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea placeholder="请输入内容" id="container" name="news_content" type="text/plain" style="width:600px;height:200px;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" style="line-height:32px">
                            ...
                            <input id="lian" type="radio" name="mt_color" value='3' >绿
                        </div>
                    </div>
