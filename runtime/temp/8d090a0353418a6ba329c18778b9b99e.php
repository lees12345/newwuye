<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/rule_index.html";i:1635479594;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											...
											<div class="dataTables_filter" id="sample-table-2_filter"><label>搜索: <input type="text" aria-controls="sample-table-2" placeholder="名称/标题"></label><input class="btn btn-purple btn-sm" type="submit" value="搜索"></div>
												...
												<thead>
													<tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="
														...
														</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 180px;">ID</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 125px;">用户组</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">创建时间</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="
											...
											<tr class="odd">
														...
														<td class="">
															<a href="#"><?php echo $res['id']; ?></a>
														</td>
														<td class=" "><?php echo $res['title']; ?></td>
														<td class=" "><?php echo date('Y-m-d H:i:s',$res['create_time']); ?></td>
														...
														<td class=" ">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo url('wxadmint1/admin/rule_edit'); ?>?id=<?php echo $res['id']; ?>">
																	<i class="icon-pencil bigger-130"></i>
																</a><a class="red" href="<?php echo url('wxadmint1/admin/rule_del'); ?>?id=<?php echo $res['id']; ?>">
													...
													</table><div class="row"><div class="col-sm-6"><div class="dataTables_info" id="sample-table-2_info"></div></div><div class="col-sm-6"><div class="dataTables_paginate paging_bootstrap"><ul class="pagination"><li class="prev disabled"><a href="#"><i class="icon-double-angle-left"></i></a></li><li class="active"><a href="#">1</a></li><li><a href="#">2</a></li><li><a href="#">3</a></li><li class="next"><a href="#"><i class="icon-double-angle-right"></i></a></li></ul></div></div></div></div>
										</div>
									</div>
								</div>
