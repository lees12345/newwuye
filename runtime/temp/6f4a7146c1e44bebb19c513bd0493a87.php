<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/admin_add.html";i:1635479593;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
				...
				<div class="main-content">
					...
					<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo url('wxadmint1/admin/admin_insert'); ?>">
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" required id="form-field-1" name="admin_name" placeholder="管理员用户名" class="col-xs-10 col-sm-5">
										</div>
									</div>
