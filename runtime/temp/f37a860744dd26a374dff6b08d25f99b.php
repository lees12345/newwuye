<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/rule_add.html";i:1635479594;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/admin/rule_insert'); ?>" method="post">
							<?php echo token('__hash__'); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="请输入组名称" class="col-xs-10 col-sm-5" name='title'/>
										</div>
									</div>
								    ...
								    <td>
								        <ul class="first_checkbox" style=" margin-left:10px;">
								        		<?php if(is_array($auth1) || $auth1 instanceof \think\Collection || $auth1 instanceof \think\Paginator): $i = 0; $__LIST__ = $auth1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth0): $mod = ($i % 2 );++$i;?>
								                            <li><input id="box<?php echo $auth0['id']; ?>" value="0" type="hidden">
