<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/phones/index.html";i:1635479596;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635921773;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
			...
			<div class="col-xs-12">
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<!-- 搜索框 -->
			<form class="form-search" action="<?php echo url('phones/index'); ?>">
				<span class="input-icon">
					<input type="text" placeholder="手机号码" class="nav-search-input" id="nav-search-input" autocomplete="off" name='phone' <?php if(!(empty($search) || (($search instanceof \think\Collection || $search instanceof \think\Paginator ) && $search->isEmpty()))): ?>  value=<?php echo $search; else: ?> value="" <?php endif; ?>  />
					<i class="icon-search nav-search-icon"></i>
						...
						<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($key % 2 );++$key;?>
								...
								<tbody>
									<tr>
										...
										<td><?php echo $data['pho_id']; ?></td>
										<td><?php echo $data['phone']; ?></td>
										<td>
											<?php echo $data['codes']; ?>
										</td>
										<td><?php echo date('Y-m-d H:i:s',$data['pho_time']); ?></td>
