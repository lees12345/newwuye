<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/flash_add.html";i:1635479595;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/news/flash_insert'); ?>" method="post">
                                        <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">快讯标题 </label>
                                        <div class="col-sm-9">
                                            <input type="text" id="form-field-1" placeholder="请输入内容" class="col-xs-10 col-sm-5" name='kx_title' />
                                             例：2017-12-12 快讯
                                        </div>
                                    </div>
