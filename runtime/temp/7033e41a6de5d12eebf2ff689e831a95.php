<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/learn/add.html";i:1635479595;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635484441;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
...
<!--<script src="/public/static/admin/assets/js/date-time/bootstrap-datetimepicker.fr.js"></script>-->
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/learn/insert'); ?>" method="post">
                   <!-- <?php echo token('__hash__'); ?>-->
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 预约标题（日期） </label>
                        <div class="col-sm-9">
                            <input type="text" name="learn_title" value="" >
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">选择类型 </label>
                        <div class="col-sm-9" style="line-height:32px">
                            <input id="lian" type="radio" name="learn_type" value='1'>激进型
                          <!--  <input id="lian" type="radio" name="learn_type" value='2' >稳健型-->
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">开始时间(年月日)：</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input class="form-control date-picker" id="id-date-picker-1" type="text" name='start_time' data-date-format="yyyy-mm-dd HH:ii:ss" />
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">结束时间(年月日)：</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input class="form-control date-picker" id="id-date-picker-1" type="text" name='end_time' data-date-format="yyyy-mm-dd HH:ii:ss" />
                                <span class="input-group-addon">
                                                            <i class="icon-calendar bigger-110"></i>
                                                        </span>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="timepicker1">备注：</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                                <input   type="text" name='learn_date' />
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                           ...
                           <!-- <input type="button" value='预览' id="ylan" class="btn btn-info" onclick="check()">-->
                        </div>
                    </div>
                </form>
            </div><!-- /.page-content -->
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                // $('.date-picker').datepicker({autoclose:false,
                //    format: 'yyyy-mm-dd hh:ii:ss',
                // }).next().on(ace.click_event, function(){
                //     $(this).prev().focus();
                // });
                // $('input[name=start_time]').daterangepicker().prev().on(ace.click_event, function(){
                //     $(this).next().focus();
                // });
