<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/admin_edit.html";i:1635479593;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		...
		<div class="main-content">
					...
					<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" method="post" action="<?php echo url('wxadmint1/admin/admin_upd'); ?>">
								<input type="hidden" name="passwords" value="<?php echo $res['admin_password']; ?>">
								<input type="hidden" name="admin_id" value="<?php echo $res['admin_id']; ?>">
								<input type="hidden" name="tid" value="<?php echo $zz['group_id']; ?>">

								<div class="form-group">
									
												<?php echo token('__hash__'); ?>	
														
															<label class="col-sm-3 control-label no-padding-right" for="form-field-select-1">请选择组类</label>

															<div class="col-sm-5">

																<select required class="form-control" id="form-field-select-1" name="id">
																	...
																	<option  <?php if($zz['group_id'] == $tt['id']): ?> selected <?php endif; ?> value="<?php echo $tt['id']; ?>"><?php echo $tt['title']; ?></option>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" required id="form-field-1" name="admin_name" placeholder="管理员用户名" class="col-xs-10 col-sm-5" value="<?php echo $res['admin_name']; ?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password" required id="form-field-2" placeholder="输入密码" class="col-xs-10 col-sm-5" name="admin_ypassword">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*6-16位密码</span>
											</span>
										</div>
									</div>

									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 重置密码 </label>

										<div class="col-sm-9">
											<input type="password" required id="form-field-2" placeholder="输入密码" class="col-xs-10 col-sm-5" name="admin_password">
											<span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">*6-16位密码</span>
											</span>
										</div>
