<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/users/stock.html";i:1638777702;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
...
<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
						<a href="<?php echo url('wxadmint1/users/index'); ?>">返回列表页</a>
								<form class="form-search" action="<?php echo url('wxadmint1/users/stock'); ?>">
					...
					<!-- <select name="click_type">
						<option value="">请选择查看类型
						<option value="1">交易时段查看
						<option value="2">超时
						<option value="3">失效
						<option value="4">结束点击需要

					</select> -->
          <!--<div style="display: block;margin-top: 10px;margin-left: 10px;">-->
            <!--<lable class="radioLabel"><input type="radio" value="1" name="click_type">交易时段查看</lable>-->
            <!--<lable class="radioLabel"><input type="radio" value="2" name="click_type">超时</lable>-->
            <!--<lable class="radioLabel"><input type="radio" value="3" name="click_type">失效</lable>-->
            <!--<lable class="radioLabel"><input type="radio" value="4" name="click_type">结束点击需要</lable>-->
            <!--&lt;!&ndash; <lable class="radioLabel"><input type="radio" value="6" name="click_type">结束不需要</lable> &ndash;&gt;-->
          <!--</div>-->
						...
						<input type="submit" value='搜索' class="btn btn-info" style="border:0;padding:4px 10px;background:#4f99c6;color:#fff;">&nbsp;&nbsp;查看次数：<span style="color:red;"><?php echo $count; ?></span>
				</span>
								</form>
								<div style="display: block;margin-top: 10px;" class="inputLabel">
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=0"><input type="button" value="全部" name="click_type" <?php if(($click_type==0)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=1"><input type="button" value="交易时段查看" name="click_type" <?php if(($click_type==1)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=2"><input type="button" value="超时查看" name="click_type" <?php if(($click_type==2)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=3"><input type="button" value="失效查看" name="click_type" <?php if(($click_type==3)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=4"><input type="button" value="结束点击需要" name="click_type" <?php if(($click_type==4)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=6"><input type="button" value="结束查看" name="click_type" <?php if(($click_type==6)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=7"><input type="button" value="点击解锁按钮" name="click_type" <?php if(($click_type==7)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=8&is_order=1"><input type="button" value="付费解锁" name="click_type" <?php if(($click_type==8)): ?> class="inputchecked" <?php endif; ?>></a>
									<a href="<?php echo url('wxadmint1/users/stock'); ?>?v=1&user_id=<?php echo $user_id; ?>&user_name=<?php echo $user_name; ?>&s_status=<?php echo $s_status; ?>&click_type=10"><input type="button" value="游客查看" name="click_type" <?php if(($click_type==10)): ?> class="inputchecked" <?php endif; ?>></a>
								</div>
								<div class="row">
									<div class="col-xs-12">
										<div class="table-responsive">

											<table id="sample-table-1" class="table table-striped table-bordered table-hover font">
												<thead>
													<tr>
														<th class="center" width="50px">股票ID</th>
														<th class="center" width="80px">用户姓名</th>
														<th class="center" width="150px">股票名称</th>
														<th class="center" width="150px">推送时间</th>
														<th class="center" width="150px">点击时间</th>
														<th class="center" width="60px">卖出状态</th>
														<th class="center" width="150px">卖出时间</th>
														<th class="center" width="150px">查看类型</th>
														<th class="center" width="150px">查看状态</th>
														<th>备注</th>
													</tr>
												</thead>
										<?php if(is_array($re) || $re instanceof \think\Collection || $re instanceof \think\Paginator): $i = 0; $__LIST__ = $re;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$re): $mod = ($i % 2 );++$i;?>
												...
												<tbody>
													<tr>
														...
														<td><?php echo $re['news_id']; ?></td>
														<td><?php echo $re['user_name']; ?></td>
														<td>
															<?php switch($re['shares_status']): case "1": ?><span style="color:#ff0000"><?php echo $re['news_code']; ?></span><?php break; case "2": ?><span style="color:#009900"><?php echo $re['news_code']; ?></span><?php break; case "3": ?><span style="color:#8B8989"><?php echo $re['news_code']; ?></span><?php break; default: ?>
															<span style="color:#000000"><?php echo $re['news_code']; ?></span>
															<?php endswitch; ?>

														</td>
														<td><?php echo date('Y-m-d H:i:s',$re['add_time']); ?></td>
														<td><?php if(!(empty($re['click_time']) || (($re['click_time'] instanceof \think\Collection || $re['click_time'] instanceof \think\Paginator ) && $re['click_time']->isEmpty()))): ?><?php echo date('Y-m-d H:i:s',$re['click_time']); else: ?>暂无<?php endif; ?></td>
														<td><?php switch($re['shares_status']): case "1": ?><span style="color:#ff0000">止盈</span><?php break; case "2": ?><span style="color:#009900">止损</span><?php break; case "3": ?><span style="color:#009900">超时卖出</span><?php break; case "4": ?><span style="color:#8B8989">调仓</span><?php break; default: ?>
															<span style="color:#000000">暂无</span>
															<?php endswitch; ?>
														</td>
														<td><?php if($re['end_time'] == 0): ?>暂无<?php else: ?><?php echo date('Y-m-d H:i:s',$re['end_time']); endif; ?></td>

														<td><?php switch($re['click_type']): case "1": ?>交易时段查看<?php break; case "2": ?><span style="color:blue">超时查看</span><?php break; case "3": ?><span style="color:green">失效查看</span><?php break; case "4": ?><span style="color:red">结束点击需要</span><?php break; case "6": ?><span>结束查看</span><?php break; case "7": ?><span style="color:red">点击解锁</span><?php break; case "10": ?><span style="color:#660099">游客查看</span><?php break; endswitch; ?>
														</td>
														<td><?php if($re['is_order'] == 0): ?>正常<?php else: ?><span style="color:blue">解锁查看</span><?php endif; ?></td>
														<td><?php if(!(empty($re['remark']) || (($re['remark'] instanceof \think\Collection || $re['remark'] instanceof \think\Paginator ) && $re['remark']->isEmpty()))): ?><?php echo $re['remark']; else: ?>暂无<?php endif; ?></td>
