<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/users/upd.html";i:1635479600;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/users/xiu'); ?>">
								...
								<input type="hidden" name="user_name" value="<?php echo $data['user_name']; ?>">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_name' value='<?php echo $data['user_name']; ?>' disabled/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="form-field-2" class="col-xs-10 col-sm-5" name='user_tel' value='<?php echo $data['user_tel']; ?>' disabled/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户备注 </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_remark' value='<?php echo $data['user_remark']; ?>'/>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">开发人员 </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_develop_people' value='<?php echo $data['user_develop_people']; ?>' />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">激活人员 </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_activate_people' value='<?php echo $data['user_activate_people']; ?>' />
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">新单人员 </label>
										<div class="col-sm-9">
											<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_first_people' value='<?php echo $data['user_first_people']; ?>' />
										</div>
									</div>
									<!--<div class="form-group">-->
										<!--<label class="col-sm-3 control-label no-padding-right" for="form-field-1">服务人员 </label>-->
										<!--<div class="col-sm-9">-->
											<!--<input type="text" id="form-field-1" class="col-xs-10 col-sm-5" name='user_server_people' value='<?php if($data['user_server_people'] == 0): else: ?><?php echo $data['user_server_people']; endif; ?>' />-->
										<!--</div>-->
									<!--</div>-->
									<div class="form-group">
									...
									<input type="radio" name="type_id" value='<?php echo $list['type_id']; ?>' <?php if($data['type_id'] == $list['type_id']): ?> checked <?php endif; ?> ><?php echo $list['type_name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
