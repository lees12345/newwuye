<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/profit/list.html";i:1635479597;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635995797;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                    ...
                    <div class="col-xs-12">
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <td><?php echo $list['income_id']; ?></td>
                                    <td><?php echo $list['last_year_income']; ?>%</td>
                                    <td><?php echo $list['six_month_income']; ?>%</td>
                                    <td><?php echo $list['last_month_income']; ?>%</td>
                                    <td>
                                        <a href="<?php echo url('wxadmint1/profit/upd'); ?>?income_id=<?php echo $list['income_id']; ?>"><button class="btn btn-xs btn-info">
