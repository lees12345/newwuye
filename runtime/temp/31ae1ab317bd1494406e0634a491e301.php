<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/learn/index.html";i:1635479595;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635995797;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
            ...
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class="table-responsive">
                            ...
                            <!-- 搜索框 -->
                            <form class="form-search" action="<?php echo url('wxadmint1/learn/index'); ?>">
                                <input type="hidden" name="v" value="1">
                                <span class="input-icon">

						<input type="text" placeholder="请输入预约日期" class="nav-search-input" id="nav-search-input" autocomplete="off" name='learn_title'/>
                                </span>
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $data['learn_id']; ?></td>
                                    <td><?php echo $data['learn_title']; ?></td>
                                    <td><?php echo $data['learn_url']; ?></td>
                                    <td><img src="/public/qrcode/<?php echo $data['learn_pic']; ?>" width="100px" height="100px"></td>
                                    <td><?php if($data['learn_type'] == 1): ?>激进型<?php else: ?>稳健型<?php endif; ?></td>
                                    <td><?php echo date("Y-m-d H:i:s",$data['start_time']); ?></td>
                                    <td><?php echo date('Y-m-d H:i:s',$data['end_time']); ?></td>
                                    <td><?php echo date('Y-m-d H:i:s',$data['learn_addtime']); ?></td>
                                    ...
                                    <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                            ...
                                            <a onclick="if(!confirm('您确定要删除所选用户的所有信息吗')){return false;}"  href="<?php echo url('wxadmint1/learn/del'); ?>?learn_id=<?php echo $data['learn_id']; ?>"><button class="btn btn-xs btn-danger">
                                                <i class="icon-trash bigger-120"></i>
                                            </button>
                                            </a>
                                            <a href="<?php echo url('wxadmint1/learn/lists'); ?>?learn_id=<?php echo $data['learn_id']; ?>"><button class="btn btn-xs btn-info">
                                                记录
                                            </button></a>
