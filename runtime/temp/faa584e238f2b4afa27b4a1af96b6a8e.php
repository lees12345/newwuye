<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/report/add.html";i:1635479598;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="<?php echo url('wxadmint1/report/add_pro'); ?>" method="post">
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">标题 </label>
										<div class="col-sm-9">
                                        <input type="text" id="form-field-1" placeholder="请输入报告标题" class="col-xs-10 col-sm-5" name='history_title'/>
										<!-- <textarea name="rtitle" rows="5" cols="50" id="form-field-2" class="col-xs-10 col-sm-5"></textarea> -->
										</div>
									</div>
                                        <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">摘要 </label>
                                        <div class="col-sm-9">
                                        <textarea name="history_desc" rows="5" cols="50" id="form-field-2" class="col-xs-10 col-sm-5"></textarea>
                                        </div>
                                    </div>
										<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-2">报告标记 </label>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
										<textarea required placeholder="请输入内容" id="container" name="history_content" type="text/plain" style="width:600px;height:200px;"></textarea>
										</div>
									</div>
