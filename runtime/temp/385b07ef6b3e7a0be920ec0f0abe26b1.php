<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/users/state_list.html";i:1635479600;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php if($data['is_click'] == 0): ?>未点击<?php else: ?><span style="color: red;">已点击</span><?php endif; ?></td>
                                    <td><?php if($data['click_time'] == 0): ?>暂无<?php else: ?><?php echo date('Y-m-d H:i:s',$data['click_time']); endif; ?></td>
                                </tr>
                                </tbody>
