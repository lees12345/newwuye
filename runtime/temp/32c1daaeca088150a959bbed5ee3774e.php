<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/users/push.html";i:1635479600;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $re['news_code']; ?></td>
                                    <td><?php echo date('Y-m-d H:i:s',$re['add_time']); ?></td>
                                    <td><?php switch($re['shares_status']): case "1": ?><span style="color:#ff0000">止盈提示</span><?php break; case "2": ?><span style="color:green">风险提示</span><?php break; case "3": ?><span style="color:blue">调仓提示</span><?php break; default: ?>
                                        暂无
                                        <?php endswitch; ?>
                                    </td>
