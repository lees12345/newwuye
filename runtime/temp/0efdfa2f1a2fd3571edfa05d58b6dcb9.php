<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/report/index.html";i:1635479598;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
							...
							<br/>
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														<td><?php if($list['history_type'] == 1): ?>周报<?php elseif($list['history_type'] == 2): ?>月报<?php endif; ?></td>
														<td><?php echo $list['history_title']; ?></td>
														<td>
															<textarea rows="5" cols="20">
																<?php if(empty($list['history_desc'])): ?>无摘要<?php else: ?><?php echo $list['history_desc']; endif; ?>
															</textarea>
														</td>
														<td>
															<textarea rows="5" cols="20">
																<?php if(empty($list['history_content'])): ?>无内容<?php else: ?><?php echo $list['history_content']; endif; ?>
															</textarea>
														</td>
														<td><?php echo date('Y-m-d H:i:s',$list['history_addtime']); ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																<a href="<?php echo url('wxadmint1/report/upd'); ?>?history_id=<?php echo $list['history_id']; ?>"><button class="btn btn-xs btn-info">
																	<i class="icon-edit bigger-120"></i>
																</button>
																</a>
																</button>
																</a>
																<a onclick="if(!confirm('您确定要删除所选所有模板信息吗')){return false;}"  href="<?php echo url('wxadmint1/report/del'); ?>?history_id=<?php echo $list['history_id']; ?>"><button class="btn btn-xs btn-danger">
