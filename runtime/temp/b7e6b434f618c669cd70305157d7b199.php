<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/add_message.html";i:1635479593;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1635484441;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" action="<?php echo url('setMessage'); ?>" method="post">
                    <?php echo token('__hash__'); ?>

                    <div class="space-4"></div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">发送内容 </label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-2">推送客户类型(默认是全部选中的状态) </label>
                        <div class="col-sm-9" style="line-height:32px">
                            ...
                            <input type="checkbox" name="type[]" value='<?php echo $type['type_id']; ?>' checked><?php echo $type['type_name']; endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                    ...
                    <!--<div class="form-group">-->
                        ...
                        <!--<div class="col-sm-9">-->
                            <!--<select id="learn" name="learn" class="col-xs-10 col-sm-5">-->
                                ...
                                <!--<option value="<?php echo $learn['learn_id']; ?>"><?php echo $learn['learn_title']; ?>&#45;&#45;<?php if($learn['learn_type'] == 1): ?>激进型<?php else: ?>稳健型<?php endif; ?>-->
                    ...
                    <!--</div>-->
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 发送类型 </label>

                        <div class="col-sm-9">
                            <select id="learn" name="wx_type" class="col-xs-10 col-sm-5" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="order" placeholder="数字1,2,3等等">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 发送时间 </label>

                        <div class="col-sm-9">
                            <input type="text" name="send_time" placeholder="格式：时:分 如 17:29">
                        </div>
                    </div>
...
//scaleEnabled {Boolean} [默认值：false]//是否可以拉伸长高，(设置true开启时，自动长高失效)
            ...
            function check(){
                ...
                var lei = $("#lei option:selected").val();
                // alert(lei);
                var zhai = $("#zhai").val();
                // alert(zhai);
                var lian = $("#lian:checked").val();
                // alert(lian);

                var nei = ue.getContent();
                // alert(nei);
                ...
                $.ajax({
                    type: "POST",
                    url: "yulan.html",
                    data: {lei:lei,zhai:zhai,lian:lian,nei:nei},
                    dataType: "json",
