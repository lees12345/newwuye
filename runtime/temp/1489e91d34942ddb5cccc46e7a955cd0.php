<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/survey/shows.html";i:1635479600;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
    ...
    <div class="page-content">
        <div class="page-header">
            <h1>
                ...
                <small>
                    <i class="icon-double-angle-right"></i>
                    用户   <span style="color: red;"><?php echo $users['user_tel']; ?></span>   问卷调查
                </small>
            </h1>
        </div><!-- /.page-header -->
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" action="" method="post">
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="11">标题</label>
                        <div class="col-sm-9">
                            <input type="text" id="1" class="col-xs-10 col-sm-5" name='name' value="<?php echo $survey['title']; ?>" disabled="disabled"/>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="22">类型</label>

                        <div class="col-sm-9">
                            <input type="text" id="2" class="col-xs-10 col-sm-5" name='name' value="<?php echo $que_type[$survey['que_type']]; ?>" disabled="disabled"/>
                        </div>
                    </div>

                    <!--循环问题数据-->
                    <?php if(is_array($que) || $que instanceof \think\Collection || $que instanceof \think\Paginator): $k = 0; $__LIST__ = $que;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$que): $mod = ($k % 2 );++$k;?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><span style="color: red;">问题  <?php echo $k; ?></span></label>
                        <div class="col-sm-5">
                            <input type="text"  class="col-xs-10 col-sm-5" name='name' value="<?php echo $que['item_title']; ?>"  style="background-color: white;" autocomplete="off"/>
                        </div>
                    </div>
                    <?php if(is_array($que['value']) || $que['value'] instanceof \think\Collection || $que['value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $que['value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><?php echo $value['item_tag']; ?>、</label>
                        <div class="col-sm-5">
                            <?php if($value['oid'] == $que['answer']): ?>
                            <input type="text"  class="col-xs-10 col-sm-5" name='name' value="<?php echo $value['item_val']; ?>"  style="background-color: #99FFFF;" autocomplete="off"/>
                            <?php else: ?>
                            <input type="text"  class="col-xs-10 col-sm-5" name='name' value="<?php echo $value['item_val']; ?>"  />
                            <?php endif; ?>
                        </div>
                    </div>
