<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/admin/auth_index.html";i:1635479594;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
						...
						<div class="row">
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											...
											<div class="dataTables_filter" id="sample-table-2_filter"><label>搜索: <input type="text" aria-controls="sample-table-2" placeholder="名称/标题"></label><input class="btn btn-purple btn-sm" type="submit" value="搜索"></div>
											</form>
												...
												<thead>
													<tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="
														...
														</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending" style="width: 180px;">ID</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 125px;">名称</th><th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 135px;">方法</th><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="
											...
											<?php if(is_array($auth0) || $auth0 instanceof \think\Collection || $auth0 instanceof \think\Paginator): $i = 0; $__LIST__ = $auth0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$auth): $mod = ($i % 2 );++$i;?>
											<tr class="odd">
														...
														<td class="">
															<a href="#"><?php echo $auth['id']; ?></a>
														</td>
														<td class=" "> <?php if($auth['pid'] != 0): ?>  &nbsp;  &nbsp; &nbsp;|--<?php endif; ?><?php echo $auth['title']; ?> </td>
														<td class=" "><?php echo $auth['name']; ?></td>
														...
														<td class=" ">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="<?php echo url('wxadmint1/admin/auth_edit'); ?>">
