<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/only.1yuaninfo.com/./application/wxadmint1/view/news/flash_index.html";i:1635479595;s:71:"/home/wwwroot/only.1yuaninfo.com/application/wxadmint1/view/layout.html";i:1637143029;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
												<tbody>
													<tr>
														<td><?php echo $list['kx_id']; ?></td>
														<td><?php echo $list['kx_title']; ?></td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">

																<a onclick="if(!confirm('您确定要删除所选所有模板信息吗')){return false;}"  href="<?php echo url('wxadmint1/news/flash_del'); ?>?kx_id=<?php echo $list['kx_id']; ?>"><button class="btn btn-xs btn-danger">
																	<i class="icon-trash bigger-120"></i>
																</button>
																</a>

																<a href="<?php echo url('wxadmint1/news/flash_watchs'); ?>?news_id=<?php echo $list['kx_id']; ?>"><button class="btn btn-xs">
																	点击查看的客户列表
																</button>
																</a>
															</div>
